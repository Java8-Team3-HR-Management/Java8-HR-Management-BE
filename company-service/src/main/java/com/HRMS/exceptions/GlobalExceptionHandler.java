...
import static com.HRMS.exceptions.ErrorType.BAD_REQUEST_ERROR;
import static com.HRMS.exceptions.ErrorType.REGISTER_KULLANICIADI_KAYITLI;
...
@ResponseBody
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> SpringStartExceptionHandler(CompanyException ex){
