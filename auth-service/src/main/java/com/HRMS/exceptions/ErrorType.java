...
public enum ErrorType {
    ...
    MAIL_ALREADY_HAS_BEEN(1007,"Mail address already has been ",HttpStatus.BAD_REQUEST),
    FORGOT_PASSWORD_INVALID_EMAIL(1008,"This mail address does not exist",HttpStatus.BAD_REQUEST),
    REQUIRED_FIELD(1009,"Zorunlu alanlar hatalı gelmekte",HttpStatus.BAD_REQUEST);
