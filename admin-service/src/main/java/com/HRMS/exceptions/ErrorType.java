...
public enum ErrorType {
    ...
    REGISTER_KULLANICIADI_KAYITLI(1001,"Kullanıcı adÄı kayıtlı",HttpStatus.BAD_REQUEST),
    ...
    MAIL_ALREADY_HAS_BEEN(1003,"Mail addrees alreadly has been ",HttpStatus.BAD_REQUEST),

    ADMIN_ALREADY_EXIST(1006,"Admin kayıtlı!",HttpStatus.BAD_REQUEST);
    int code;
    String message;
